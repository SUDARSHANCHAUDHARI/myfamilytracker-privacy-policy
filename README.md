...
This repository hosts the privacy policy for the MyFamilyTracker Android application. The privacy policy is publicly accessible and can be linked from the Google Play Store listing.
